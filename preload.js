...
const I18N = {
  ...
  ru: {
    ...
    muteTitle: 'Выкл. / вкл. звук',
    muteOn: 'Звук выключен',
    muteOff: 'Звук включён',
    dragTitle: 'Удерживайте, чтобы перетащить окно',
  ...
  fr: {
    ...
    muteTitle: 'Couper / rétablir le son',
    muteOn: 'Son coupé',
    muteOff: 'Son rétabli',
    dragTitle: 'Maintenir pour déplacer la fenêtre',
  ...
  es: {
    ...
    muteTitle: 'Silenciar / reactivar',
    muteOn: 'Silenciado',
    muteOff: 'Sonido reactivado',
    dragTitle: 'Mantén pulsado para arrastrar la ventana',
  ...
  uk: {
    ...
    muteTitle: 'Вимкнути / увімкнути звук',
    muteOn: 'Звук вимкнено',
    muteOff: 'Звук увімкнено',
    dragTitle: 'Утримуйте, щоб перетягнути вікно',
  ...
  ka: {
    ...
    muteTitle: 'ხმის ჩახშობა / ჩართვა',
    muteOn: 'ხმა გამორთულია',
    muteOff: 'ხმა ჩართულია',
    dragTitle: 'დააჭირეთ ფანჯრის გადასაადგილებლად',
  ...
  hy: {
    ...
    muteTitle: 'Խլացնել / վերականգնել',
    muteOn: 'Խլացված է',
    muteOff: 'Ձայնը վերականգնված է',
    dragTitle: 'Պահեք՝ պատուհանը տեղափոխելու համար',
  ...
  mg: {
    ...
    muteTitle: 'Ampangotra / avereno ny feo',
    muteOn: 'Voampangotra ny feo',
    muteOff: 'Naverina ny feo',
    dragTitle: 'Tsindrio mba hampihetsika ny fikandrana',
